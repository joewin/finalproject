...
interface CivicsApiService {
    ...
    @GET("voterinfo")
    suspend fun getVoterInfoResponse(@Query("address") address: String,
                                    @Query("electionId") electionId: Int): VoterInfoResponse
    //TODO: Add representatives API Call
    @GET("representatives")
    suspend fun getRepresentativesResponse(@Query("address")
                                               address:String): RepresentativeResponse
}
